      ...
      [
        {
          ...
          data: [
            ...
            },
            {
              ...
              hotkey: 'Ctrl+S',
              btnText: 'S',
              icon: { glyph: 'glyphicon glyphicon-strikethrough', fa: 'fa fa-strikethrough', 'fa-3': 'icon-strikethrough' },
              callback: function (e) {
                // Give/remove * surround the selection
                var chunk,
                  cursor,
          ...
          data: [
            ...
            },
            {
              ...
              callback: function (e) {
                ...
                // transform selection and set the cursor into chunked text
                if (content.substr(selected.start - 3, 3) === '```' && content.substr(selected.end, 3) === '```') {
